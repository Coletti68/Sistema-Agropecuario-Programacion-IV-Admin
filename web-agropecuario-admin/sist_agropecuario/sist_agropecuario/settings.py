"""
Django settings for sist_agropecuario project.
...
SECRET_KEY = 'django-insecure-n1ahy^j0n#eo#5o%x7kf=*!=jhq9!+1m*3sgj1*c2q1p2-312p'
...
TEMPLATES = [
    {
        ...
        # Carpeta global de templates (ej: api/templates)
